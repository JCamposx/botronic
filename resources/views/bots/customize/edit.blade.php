...
@section('content')
  <div class="container">
    <h3>Editar respuesta personalizada para {{ $bot->name }}</h3>
    ...
    <form method="POST"
      action="{{ route('bots.customize.update', [$bot->id, $customAnswer->id]) }}">
      @csrf
      @method('PUT')
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input id="question" type="text"
                    ...
                    name="question"
                    value="{{ old('question') ?? $customAnswer->question }}"
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input id="answer" type="text"
                    ...
                    name="answer"
                    value="{{ old('answer') ?? $customAnswer->answer }}"
                    autocomplete="answer">
